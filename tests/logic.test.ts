  ...
  describe('range', () => {
    ...
    describe('uniform', () => {
      ...
      it('singleLast', () => {
        ...
        expectRange(range(totalHeight - 5, 4, rowHeight, exceptions, numberOfRows), lastIndex, lastIndex, lastRowPos, lastRowPos + rowHeight);
      });
      ...
      it('shift', () => {
        ...
        expectRange(range(0, totalHeight - 6, rowHeight, exceptions, numberOfRows), 0, lastIndex - 1, 0, totalHeight - rowHeight);
      });
    ...
    describe('nonUniform', () => {
      ...
      describe('multiple', () => {
        ...
        it('betweenInOut', () => {
          expectRange(range(ex3Middle, (ex7Middle - 3) - ex3Middle, rowHeight, exceptions, numberOfRows), 3, 6, 3 * rowHeight, 7 * rowHeight + 1);
        });

        it('betweenInIn', () => {
          expectRange(range(ex3Middle, ex7Middle - ex3Middle, rowHeight, exceptions, numberOfRows), 3, 7, 3 * rowHeight, 8 * rowHeight + 1 + 1);
        });
